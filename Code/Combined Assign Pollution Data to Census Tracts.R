...
input_directory <- "/Users/kevintu/Library/CloudStorage/OneDrive-UniversityofMarylandSchoolofMedicine/Climate Health Internship/AERMOD View Modeling Results/BenMAP Reformatted/Combined"

# Set the desired path and name for the final output file.
output_file_path <- file.path(dirname(input_directory), "Combined Concentrations by Census Tract.csv")
...
for (file_path in files_to_process) {
  ...
  match_groups <- str_match(file_name, "reformatted_Combined\\s(.*?)\\s(\\S+)\\sAnnual\\.csv")
